		...
		<view class="list" v-if='from==1'>
			<view class='teachingCon' v-if='textbook_list.length!=0'>
				<view class="card" @click="chooseTeaching(i)" v-for="(item,i) of textbook_list" :key='i'>
					...
					<image :src="item.status?'//aictb.oss-cn-shanghai.aliyuncs.com/wx_xcx/icon/gou.png':'//aictb.oss-cn-shanghai.aliyuncs.com/wx_xcx/icon/default_red.png'" mode="" class='detail'></image>
				</view>
			</view>
